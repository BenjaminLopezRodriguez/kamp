      ...
      <section className="flex flex-col-reverse items-center gap-12 pt-24 pb-32 md:flex-row">
        <div className="max-w-xl space-y-8">
          ...
          <div className="flex gap-4 pt-4">
            ...
            {isAuthenticated ? (
              <Button asChild variant="outline" className="rounded-full border-gray-300 px-8 py-6 text-gray-700 transition-all duration-300 hover:bg-gray-50">
              ...
              <>
                ...
                <Button asChild className="transform rounded-full bg-blue-600 px-8 py-6 text-white shadow-lg transition-all duration-300 hover:-translate-y-0.5 hover:bg-blue-700">
